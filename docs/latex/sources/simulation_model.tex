...
models. The force actually delivered to the ground is reduced by
...
evaluate the right-hand side within every transition zone, at the cost of some
integration speed only when track geometry is enabled.
