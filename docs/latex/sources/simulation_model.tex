...
(RK45, the Dormand-Prince pair) and default error tolerances. RK45's adaptive
step-size control is a good match for the smooth power/drag dynamics away from
corners.
