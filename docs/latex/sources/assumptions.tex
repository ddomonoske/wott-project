...
\begin{itemize}
    ...
    purpose; since $v_{\mathrm{wheel}} - v \approx v\,\kappa h \sin\theta$ to
    leading order, the difference is first-order (linear) in $\kappa h
    \sin\theta$, and small in practice for realistic lean angles, but is not
    corrected for.
